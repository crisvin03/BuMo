import 'package:BuMo/utils/widgets/sender_chat.dart';
import 'package:BuMo/utils/widgets/receiver_chat.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:BuMo/models/messaging.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final String myID = "Crisvin Habitsuela";
  final String senderID = "Crisvin Habitsuela";

  final String myID2 = "Pogi Ko";
  final String senderID2 = "Crisvin Habitsuela";

  final String myID3 = "Joshua Godalle";
  final String senderID3 = "Joshua Godalle";
