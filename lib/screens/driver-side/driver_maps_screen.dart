...
import 'package:BuMo/utils/widgets/driver-side-widgets/booking_info_widget.dart';
...
class DriverMapsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    BookComplete passenger = BookComplete(
      ...
      destinationLoc: GeoPoint(12.6719, 123.8778),
      driverID: 'driver123',
      initialLoc: GeoPoint(10.29716766666733, 123.89974298092177),
      passengerID: 'passenger456',
      passengerName: 'Crisvin Habitsuela',
      pickupLoc: GeoPoint(12.6717, 123.8753),
