...
import 'package:BuMo/models/booking_complete.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:BuMo/utils/functions/name_coordinates.dart';
import 'dart:math';
...
class BookingNotifier extends StateNotifier<Booking?> {
  ...
  Future<BookComplete> updateLocationNames(BookComplete passenger) async {
    double initialLocLatitude = passenger.initialLoc.latitude;
    double initialLocLongitude = passenger.initialLoc.longitude;
    double pickupLocLatitude = passenger.pickupLoc.latitude;
    double pickupLocLongitude = passenger.pickupLoc.longitude;
    double destinationLocLatitude = passenger.destinationLoc.latitude;
    double destinationLocLongitude = passenger.destinationLoc.longitude;
